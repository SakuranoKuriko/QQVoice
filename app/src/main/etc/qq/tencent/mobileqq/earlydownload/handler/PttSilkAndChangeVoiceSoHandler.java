  ...
  extends EarlyHandler
{
  ...
  public boolean h()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("PttSilkAndChangeVoiceSoHandler", 2, "isUserNeedDownload cpuArch = " + i + " isUserNeedDownload try match version=" + "7.7.8" + " data.version=" + ((PttSilkAndChangeVoiceSoData)localObject).version);
    }
...
/* Location:              D:\1\!\com\tencent\mobileqq\earlydownload\handler\PttSilkAndChangeVoiceSoHandler.class
