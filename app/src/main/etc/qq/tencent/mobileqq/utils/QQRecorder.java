...
public class QQRecorder
{
  ...
  public static int a(String paramString)
  {
    ...
    //   52: aload 8
    //   54: invokestatic 248	com/tencent/mobileqq/utils/RecordParams:a	([B)Z
    //   57: ifeq +54 -> 111
    //   60: aload 8
    //   62: iconst_0
    //   63: baload
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_Almy != null) && (this.jdField_a_of_type_Almy.a())) {}
    synchronized (this.jdField_a_of_type_Almy)
    {
      this.jdField_a_of_type_Almy.jdField_b_of_type_Boolean = false;
    }
  }
  ...
  public void a(QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    ThreadManager.excute(new almx(this), 16, null, false);
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ChatActivity", 2, "thread is:" + this.jdField_a_of_type_Almy + ",time is:" + System.currentTimeMillis());
    }
    if (this.jdField_a_of_type_AndroidMediaAudioManager != null) {}
    try
    {
    ...
    catch (Exception localException)
    {
      ...
      synchronized (this.jdField_a_of_type_Almy)
      {
        this.jdField_a_of_type_Almy.jdField_b_of_type_Boolean = true;
        this.jdField_a_of_type_Almy.jdField_a_of_type_JavaLangString = paramString;
        try
        {
          notifyAll();
          return;
    ...
    if ((this.jdField_a_of_type_Almy == null) || (!this.jdField_a_of_type_Almy.a()))
    {
      ...
      this.jdField_a_of_type_Almy = new almy(this);
      this.jdField_a_of_type_Almy.jdField_a_of_type_JavaLangString = paramString;
      this.jdField_a_of_type_Almy.start();
      return;
    }
  }
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Almy != null) && (this.jdField_a_of_type_Almy.jdField_a_of_type_Boolean);
  }
  ...
  public boolean c()
  {
    ...
    {
      boolean bool = this.jdField_a_of_type_Almy.jdField_a_of_type_Boolean;
      this.jdField_a_of_type_Almy.jdField_a_of_type_Boolean = false;
      return bool;
    }
    return false;
  }
...
/* Location:              D:\1\!\utils\QQRecorder.class
