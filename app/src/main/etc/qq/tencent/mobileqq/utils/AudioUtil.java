...
public class AudioUtil
{
    ...
    for (;;)
    {
      ...
      if (paramInt1 != AppSetting.e)
      {
        ...
        if (jdField_a_of_type_AndroidMediaMediaPlayer != null)
        {
          ...
          jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new aliv(paramOnCompletionListener, paramHandler));
      ...
      continue;
      label154:
      paramHandler.post(new alix(paramOnCompletionListener));
    }
  }
  ...
  public static void a(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new alit());
      jdField_a_of_type_AndroidMediaMediaPlayer.start();
  ...
  public static void a(Uri paramUri, int paramInt, MediaPlayer.OnCompletionListener paramOnCompletionListener)
  {
    ...
    //   263: dup
    //   264: aload_2
    //   265: invokespecial 279	aliz:<init>	(Landroid/media/MediaPlayer$OnCompletionListener;)V
  ...
  public static void a(Uri paramUri, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   126: new 287	aliy
    //   129: dup
    //   130: invokespecial 288	aliy:<init>	()V
  ...
  public static void a(String paramString, boolean paramBoolean)
  {
    ...
    //   143: new 295	alis
    //   146: dup
    //   147: invokespecial 296	alis:<init>	()V
  ...
  public static void b(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new aliu());
      jdField_a_of_type_AndroidMediaMediaPlayer.start();
      jdField_a_of_type_AndroidMediaMediaPlayer.setLooping(paramBoolean);
    }
  }
...
/* Location:              D:\1\!\utils\AudioUtil.class
