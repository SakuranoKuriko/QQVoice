...
public class QQUtils
{
  ...
  {
    paramActivity = new Dialog(paramActivity, 2131624522);
    paramActivity.setContentView(2130970482);
    TextView localTextView3 = (TextView)paramActivity.findViewById(2131370693);
    TextView localTextView4 = (TextView)paramActivity.findViewById(2131370695);
    TextView localTextView1 = (TextView)paramActivity.findViewById(2131370690);
    TextView localTextView2 = (TextView)paramActivity.findViewById(2131370691);
    localTextView3.setText(paramString1);
    localTextView4.setText(new SpannableString(paramString2));
    paramString1 = (ImageView)paramActivity.findViewById(2131370694);
    ((ImageButton)paramActivity.findViewById(2131367045)).setOnClickListener(new alnd(paramActivity));
    if (paramInt >= 0)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString1, String paramString2, int paramInt2, Handler paramHandler, int paramInt3)
  {
    ...
    {
      paramString1 = paramQQAppInterface.getApp().getString(2131435333);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else
        {
          ...
          paramHandler.postDelayed(new alnc(a(paramQQAppInterface.getApp(), new String[] { paramString2 }), paramQQAppInterface, paramInt2), paramInt3);
          return;
        }
      }
      ...
      catch (URISyntaxException localInterruptedException2)
      {
        for (;;)
        {
          try
          {
            ...
            str = ((Intent)localObject2).getStringExtra("uinname");
            if (paramString.endsWith("sid"))
            {
              localObject1 = a(null, ((Intent)localObject2).getStringExtra("sid"), String.valueOf(k), paramQQAppInterface, true);
              a(paramQQAppInterface, (Intent)localObject2);
            }
          }
          ...
          {
            Thread.sleep(1000L);
            a(paramQQAppInterface, (Intent)localObject2, str, (Bitmap)localObject1);
          }
          catch (InterruptedException localInterruptedException2)
          {
            try
            {
              ...
              localObject2 = localObject1;
              continue;
              localObject1 = SkinUtils.a(paramQQAppInterface.b(((Intent)localObject2).getStringExtra("uin")));
              continue;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, MqqHandler paramMqqHandler, int paramInt2, String paramString3, int paramInt3)
  {
    ...
    if (a(paramQQAppInterface.getApp(), new String[] { paramString2 }))
    {
      paramString1 = paramQQAppInterface.getApp().getString(2131435333);
      if (paramString1 != null) {
        paramMqqHandler.post(new alna(paramQQAppInterface, paramString1, paramInt1));
      }
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    paramMqqHandler.postDelayed(new alnb(a(paramQQAppInterface.getApp(), new String[] { paramString2 }), paramQQAppInterface, paramInt1, paramString3), paramInt2);
  }
...
/* Location:              D:\1\!\utils\QQUtils.class
