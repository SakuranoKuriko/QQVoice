  ...
  implements IPttPlayerListener
{
  ...
  private Runnable jdField_a_of_type_JavaLangRunnable = new alob(this);
  ...
  private void g()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_a_of_type_AndroidOsHandler != null)
      {
        ...
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(new aloc(this), 500L);
        return;
      }
      a(false);
      return;
...
/* Location:              D:\1\!\utils\VoicePlayer.class
