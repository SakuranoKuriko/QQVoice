...
public class Pcm2AmrWrapper
{
  ...
  private byte[] jdField_a_of_type_ArrayOfByte = new byte['ŀ'];
  private int jdField_b_of_type_Int;
  private byte[] jdField_b_of_type_ArrayOfByte;
  private int jdField_c_of_type_Int;
  private byte[] jdField_c_of_type_ArrayOfByte = new byte['ŀ'];
  private int jdField_d_of_type_Int = 1;
  private byte[] jdField_d_of_type_ArrayOfByte = new byte['⠀'];
  private int e;
  private int f;
...
/* Location:              D:\1\!\utils\Pcm2AmrWrapper.class
