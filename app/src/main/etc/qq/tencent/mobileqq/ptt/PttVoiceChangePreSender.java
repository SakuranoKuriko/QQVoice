...
public class PttVoiceChangePreSender
{
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (this.d != -1)
    {
      ReportController.b(paramQQAppInterface, "CliOper", "", "", "0X800608D", "0X800608D", this.h + 10, 0, this.d + "", paramInt + "", "", "7.7.8");
      if (this.h == 2)
      {
        if (this.d != paramInt) {
          break label235;
    ...
    for (float f1 = 0.9F;; f1 = this.jdField_a_of_type_Float)
    {
      ...
      b();
      if (this.e != -1) {
        ReportController.b(paramQQAppInterface, "CliOper", "", "", "0X800608D", "0X800608D", this.i + 20, 0, this.e + "", paramInt + "", "", "7.7.8");
      }
      if (paramInt >= 0) {
        break label274;
      }
...
/* Location:              D:\1\!\com\tencent\mobileqq\ptt\PttVoiceChangePreSender.class
